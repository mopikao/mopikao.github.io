...
#git branch -M main
#git remote add origin https://github.com/mopikao/TraditionalCalendar.git
...
git remote set-url origin https://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@github.com/mopikao/mopikao.gituhb.io.git
